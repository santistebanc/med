...
export default class extends React.Component {
  state = { error: undefined, videoready: false, loadvideo: false, mouseover: false, poster: '/static/posterNotFound.png' }
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <div className="root" onMouseEnter={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} >
        ...
        {!this.props.noDurationBar && !this.state.mouseover && <div className={"overlay"}>
